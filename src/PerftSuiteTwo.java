...
public class PerftSuiteTwo {
	...
	String[] depthGoals = { "20 400 8902 197281 4865609 119060324",
			"18 92 1670 10138 185429 1134888", "15 66 1197 7059 133987 764643",
	...
	public PerftSuiteTwo() {
		...
		totalTimer.start();
		for (int count = 0; count < boardList.length; count++) {
			// set up the new board
			Board b = new Board(boardList[count]);
			// set up goals
			String[] goals = depthGoals[count].split(" ");
			System.out.println("fen #" + (count + 1) + ": " + b.getFEN());
			Timer fen = new Timer();
			fen.start();
