...
public class Board {
    ...
    public ArrayList<Integer> writeRookMovementNeo(int square) {
    ...
    public ArrayList<Integer>  writeKingnMovementNeo(int square) {
        ArrayList<Integer>  ans = new ArrayList<Integer>();
        long moves = 0L;
    ...
    public ArrayList<Integer> writeKnightMovementNeo(int square) {
        ArrayList<Integer>  ans = new ArrayList<Integer>();
        long moves = 0L;
    ...
    public ArrayList<Integer> writeBishopMovementNeo(int square) {
        ArrayList<Integer> ans = new ArrayList<Integer>();
        long binaryS = 1L << square;
        long r = Long.reverse(binaryS);
        long twoR = 2 * r;
    ...
    public ArrayList<Integer> writeQueenMovementNeo(int square) {
        ArrayList<Integer> ans = new ArrayList<Integer>();
        long binaryS = 1L << square;
        long r = Long.reverse(binaryS);
        long twoR = 2 * r;
    ...
    public ArrayList<Integer> writeWhiteMovementNeo() {
        ArrayList<Integer> ans = new ArrayList<Integer>();
        for (long temp = (wr | wb | wn | wq); temp != 0; temp -= 1L << Long
                .numberOfTrailingZeros(temp)) {
            switch (pieceAtSquare(Long.numberOfTrailingZeros(temp))) {
                case wrn:
                    ans.addAll(writeRookMovementNeo((Long.numberOfTrailingZeros(temp))));
                    break;
                case wnn:
                    ans.addAll(writeKnightMovementNeo((Long.numberOfTrailingZeros(temp))));
                    break;
                case wbn:
                    ans.addAll(writeBishopMovementNeo((Long.numberOfTrailingZeros(temp))));
                    break;
                case wqn:
                    ans.addAll(writeQueenMovementNeo((Long.numberOfTrailingZeros(temp))));
                    break;
            }
        }
    ...
    public ArrayList<Integer> writeBlackMovementNeo() {
        ArrayList<Integer> ans = new ArrayList<Integer>();
    ...
    public ArrayList<Integer> writeWhitePawnMovementNeo() {
        ArrayList<Integer> ans = new ArrayList<Integer>();
        long them = getBlack();
        long empty = getEmpty();
        ...
        for (long temp = moveOne; temp != 0; temp -= 1L << Long
                .numberOfTrailingZeros(temp)) {
            ans.add(1000*(Long.numberOfTrailingZeros(temp) - 8)+10*Long.numberOfTrailingZeros(temp));
        }
        for (long temp = moveTwo; temp != 0; temp -= 1L << Long
                .numberOfTrailingZeros(temp)) {
            ans.add(1000*(Long.numberOfTrailingZeros(temp) - 16)+10*Long.numberOfTrailingZeros(temp));
        }

        for (long temp = attackLeft; temp != 0; temp -= 1L << Long
                .numberOfTrailingZeros(temp)) {
            ans.add(1000*(Long.numberOfTrailingZeros(temp) - 7) + 10*Long.numberOfTrailingZeros(temp));
        }

        for (long temp = attackRight; temp != 0; temp -= 1L << Long
                .numberOfTrailingZeros(temp)) {
            ans.add(1000*(Long.numberOfTrailingZeros(temp) - 9)+10*Long.numberOfTrailingZeros(temp));
        }
        ...
        for (long temp = enPassantLeft; temp != 0; temp -= 1L << Long
                .numberOfTrailingZeros(temp)) {
            ans.add(1000*(Long.numberOfTrailingZeros(temp) - 7 )+ 10*Long.numberOfTrailingZeros(temp) + 9);
        }

        for (long temp = enPassantRight; temp != 0; temp -= 1L << Long
                .numberOfTrailingZeros(temp)) {
            ans.add(1000*(Long.numberOfTrailingZeros(temp) - 9) + 10*Long.numberOfTrailingZeros(temp) + 9);
        }
        return ans;
    }
    ...
    /*public ArrayList<Integer> sortMoves(ArrayList<Integer> moves) {
        if (moves.size() < 6)
            return moves;
        String newMoves = "";
